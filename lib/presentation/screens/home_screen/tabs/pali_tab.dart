...
import 'package:pali_dictionary/presentation/screens/home_screen/widgets/pali_card.dart';
import 'package:sizer/sizer.dart';

import 'package:pali_dictionary/data/models/word_model.dart';

class PaliTab extends StatefulWidget {
  const PaliTab({
    Key? key,
  }) : super(key: key);

  @override
  State<PaliTab> createState() => _PaliTabState();
}

class _PaliTabState extends State<PaliTab> {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<DictionaryCubit>(context).getAllWords(isSanskrit: true);
    return Column(
      children: [
        Container(
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return PaliCard(wordModel: wordModel);
                              },
                            ),
                          ],
                        );
